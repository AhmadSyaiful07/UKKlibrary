    ...
    <div class="layout-container">
      ...
      <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
        ...
        <ul class="menu-inner py-1">
          ...
          <!-- Dashboard -->
          <li class="menu-item <?php if ($url == NULL) {
                                  echo "active";
                                } ?>">
          ...
          <?php if ($this->session->userdata('role') == 'Admin') { ?>
            <li class="menu-item <?php if ($url == 'user') {
                                    echo "active";
                                  } ?>">
            ...
            <li class="menu-item <?php if ($url == 'kategori') {
                                    echo "active";
                                  } ?>">
            ...
            <li class="menu-item <?php if ($url == 'buku') {
                                    echo "active";
                                  } ?>">
            ...
            <li class="menu-item <?php if ($url == 'peminjaman') {
                                    echo "active";
                                  } ?>">
          ...
          <?php if ($this->session->userdata('role') == 'Peminjam') { ?>
            ...
            <li class="menu-item <?php if ($url == 'koleksi') {
                                    echo "active";
                                  } ?>">
            ...
            <li class="menu-item <?php if ($url == 'Peminjaman') {
              ...
              <a href="<?= base_url('Peminjam/Peminjaman') ?>" class="menu-link">
                ...
                <div data-i18n="Analytics">Riwayat Peminjamaan</div>
              </a>
            </li>
          <?php } ?>
              ...
              <li class="nav-item navbar-dropdown dropdown-user dropdown">
                <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);" data-bs-toggle="dropdown">
                  <div class="avatar avatar-online">
                    <img src="<?= base_url('sneat') ?>/assets/img/avatars/8.jpg" alt class="w-px-40 h-auto rounded-circle" />
                  </div>
                </a>
