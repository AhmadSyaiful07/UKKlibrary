            ...
            <div class="authentication-inner">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="mb-4">Please Regist your account</p>
                        ...
                        <form  action="<?= base_url('auth/simpan') ?>" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input class="form-control" type="text" name="namaLengkap" placeholder="Enter your name" autofocus="">
                            </div>
                            <div class="mb-3">
                                <label  class="form-label">Email</label>
                                <input class="form-control" type="email" name="email" placeholder="Enter your email" autofocus="">
                            </div>
                            <div class="mb-3">
                                <label  class="form-label">Password</label>
                                <input class="form-control" type="password" name="password" placeholder="Enter your password" minlength="8" maxlength="16" autofocus="">
                            </div>
                            <div class="mb-3">
                                <label class="form-label">Repeat Password</label>
                                <input class="form-control" type="password" name="password_confirm" placeholder="Repeat your password" minlength="8" maxlength="16" autofocus="">
                            </div>
                            <div class="mb-3">
